...
async def summarize_text(context: Context, text: str, max_length: int | None = None) -> str:
    ...
    return await provider.execute(prompt=prompt, system_message=system_message)


# Create the function instance
summarize_function = Function(
    name="summarize", implementation=summarize_text, description="Summarizes text using an LLM provider"
)


async def translate_text(context: Context, text: str, target_language: str, source_language: str | None = None) -> str:
...
async def generate_text(context: Context, prompt: str, max_length: int | None = 100) -> str:
    ...
    return await provider.execute(prompt=prompt, system_message=system_message, max_length=max_length)
...
async def extract_information(context: Context, text: str, query: str) -> str:
...
async def rewrite_text(context: Context, text: str, tone: str | None = None, target_audience: str | None = None) -> str:
...
async def analyze_sentiment(context: Context, text: str) -> str:
...
async def levenshtein_distance(context: Context, string1: str, string2: str) -> int:
...
async def find_longest_word(context: Context, text: str) -> str:
...
async def is_palindrome(context: Context, text: str) -> bool:
...
async def count_words(context: Context, text: str) -> int:
...
async def reverse_string(context: Context, text: str) -> str:
...
reverse_string_function = Function(
    name="reverse_string", implementation=reverse_string, description="Reverses a string without any AI involvement"
)
